    ...
    <div class="card mb-1" style="border-radius: 1.5rem;">
        ...
        :style="cardBodyStyles">
            ...
            <div class="flex-grow-1 d-flex  align-items-center" @click="toggleSeparator" style="">
                ...
                <span class="" style="margin-right: 1.5rem;">{{ dataSizeGuide.id }}</span>
            </div>
            ...
            <div class="card-body">
                ...
                <div v-if="!modelLoading">
                    <div v-if="dataModels.models.length != 0">
                        <div v-for="model in dataModels.models" :key="model.id" class="card mb-1" style="border-radius: 1.5rem;">
...
export default {
    ...
    methods: {
        async getModels(sizeGuideId) {
            ...
            const params = { size_guide_id: sizeGuideId,
                            offset: 0,
                            limit: 20 }
            try {
